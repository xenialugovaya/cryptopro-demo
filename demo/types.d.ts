export declare type WithPromise<T> = Promise<T> | T;
export declare type CapicomEncodingType = 'CAPICOM_ENCODE_ANY' | 'CAPICOM_ENCODE_BASE64' | 'CAPICOM_ENCODE_BINARY';
...
export declare type SignedMessage = string;
export interface CadesSignedData {
    ...
    VerifyCades(signedContent: string, cadesBES: number, bDetached?: boolean): WithPromise<void>;
